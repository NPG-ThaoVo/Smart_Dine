    ...
    <div>
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
        {tables.map((table) => (
          <div
            key={table._id}
            className={`group relative flex flex-col justify-between rounded-3xl transition-all duration-300 overflow-hidden border h-[280px] ${
              table.isAvailable
          ...
          >
            ...
            <div className="p-6 relative z-10">
              <div className="flex justify-between items-start">
                ...
                <div
                  className={`w-3 h-3 rounded-full ring-4 ring-black/40  ${
                    table.isAvailable
              ...
              <div className="mt-6 text-center">
                <span
                  className={`text-5xl font-black tracking-tighter ${
                    table.isAvailable ? "text-emerald-500" : "text-rose-500"
