    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/10 relative overflow-hidden">
      ...
      <div className="relative z-10 container max-w-lg mx-auto px-4 py-8">
        ...
        <div className="space-y-3">
          <Button
            className="w-full h-14 rounded-2xl bg-[#F15A0A] hover:bg-[#E24F00] text-white text-lg font-semibold"
          >
            Theo dõi đơn hàng
          </Button>
          ...
          <Button
            variant="outline"
            className="w-full h-14 rounded-2xl bg-[#F9FAFB] border border-gray-200 text-gray-900 text-lg font-semibold hover:bg-gray-100"
          >
